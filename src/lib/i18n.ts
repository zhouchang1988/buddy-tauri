...
const en = {
  ...
  'status.RUNNING_AGY': 'Antigravity running',
  ...
  'task.cancelHint': 'End this task and clean up its services; keep external or explicitly retained services',
  ...
  'settings.launcher.agy.title': 'Antigravity configuration',
  'settings.launcher.agy.label': 'Antigravity launch command',
  ...
  'settings.launcher.agy.hint': 'Launch command for Antigravity CLI (agy). The launcher uses --output-format stream-json --input-format stream-json --dangerously-skip-permissions with stdin NDJSON, sets --print-timeout from the Buddy timeout, and resumes with --conversation <id>.',
  ...
  'settings.prompts.desc': 'Extra instructions appended to the end of the system prompt sent to actors every round. Configure separately for the implementer and the reviewer; each goes only to the actor playing that role. Leave empty to append nothing.',
  'settings.prompts.implementerLabel': 'Implementer only',
  'settings.prompts.reviewerLabel': 'Reviewer only',
  'settings.prompts.placeholder': 'Optional; leave empty to append nothing',
  'settings.prompts.resetToDefault': 'Clear',
  'settings.prompts.resetConfirm': 'Clear this prompt?',
  ...
  'statusBar.actor.copy': 'Copy session resume command',
  'statusBar.actor.copied': 'Resume command copied',
  ...
  'event.service.started': 'Service started',
  'event.service.stopped': 'Service stopped',
  'event.service.cleanupCompleted': 'Service cleanup completed',
  'event.service.cleanupFailed': 'Service cleanup failed',
...
const zhCN: typeof en = {
  ...
  'status.RUNNING_AGY': 'Antigravity 运行中',
  ...
  'task.cancelHint': '结束任务并清理其服务；保留外部服务和明确要求保留的服务',
  ...
  'settings.launcher.agy.title': 'Antigravity 配置',
  'settings.launcher.agy.label': 'Antigravity 启动命令',
  ...
  'settings.launcher.agy.hint': 'Antigravity CLI（agy）的启动命令。launcher 会使用 --output-format stream-json --input-format stream-json --dangerously-skip-permissions，经 stdin NDJSON 传入 prompt，按 Buddy 超时设置 --print-timeout，并用 --conversation <id> 恢复会话。',
  ...
  'settings.prompts.desc': '追加在每轮系统提示词末尾的额外指令。可为执行者和审查者分别配置，只发给承担该角色的 actor。留空则不追加。',
  'settings.prompts.implementerLabel': '仅执行者',
  'settings.prompts.reviewerLabel': '仅审查者',
  'settings.prompts.placeholder': '可选；留空则不追加任何内容',
  'settings.prompts.resetToDefault': '清空',
  'settings.prompts.resetConfirm': '确定清空该提示词吗？',
  ...
  'statusBar.actor.copy': '复制会话恢复命令',
  'statusBar.actor.copied': '恢复命令已复制',
  ...
  'event.task.done': '已完成',
  'event.service.started': '服务已启动',
  'event.service.stopped': '服务已停止',
  'event.service.cleanupCompleted': '服务清理完成',
  'event.service.cleanupFailed': '服务清理失败',
...
const zhTW: typeof en = {
  ...
  'status.RUNNING_AGY': 'Antigravity 執行中',
  ...
  'task.cancel': '取消任務',
  'task.cancelling': '正在取消…',
  'task.cancelHint': '結束任務並清理其服務；保留外部服務和明確要求保留的服務',
  ...
  'settings.launcher.agy.title': 'Antigravity 設定',
  'settings.launcher.agy.label': 'Antigravity 啟動指令',
  ...
  'settings.launcher.agy.hint': 'Antigravity CLI（agy）的啟動指令。launcher 會使用 --output-format stream-json --input-format stream-json --dangerously-skip-permissions，經 stdin NDJSON 傳入 prompt，依 Buddy 逾時設定 --print-timeout，並用 --conversation <id> 恢復工作階段。',
  ...
  'settings.prompts.desc': '追加在每輪系統提示詞末尾的額外指令。可為執行者和審查者分別設定，只發給承擔該角色的 actor。留空則不追加。',
  'settings.prompts.implementerLabel': '僅執行者',
  'settings.prompts.reviewerLabel': '僅審查者',
  'settings.prompts.placeholder': '可選；留空則不追加任何內容',
  'settings.prompts.resetToDefault': '清空',
  'settings.prompts.resetConfirm': '確定清空該提示詞嗎？',
  ...
  'statusBar.actor.copy': '複製工作階段恢復指令',
  'statusBar.actor.copied': '恢復指令已複製',
  ...
  'event.task.done': '已完成',
  'event.service.started': '服務已啟動',
  'event.service.stopped': '服務已停止',
  'event.service.cleanupCompleted': '服務清理完成',
  'event.service.cleanupFailed': '服務清理失敗',
  'event.task.updated': '已更新',
